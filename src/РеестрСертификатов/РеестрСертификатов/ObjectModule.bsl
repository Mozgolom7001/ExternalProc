...
Функция СформироватьПечатнуюФорму1(МассивОбъектов, ОбъектыПечати)	
	...
	|	ОбластиДействияСертификатовНоменклатуры.СертификатНоменклатуры.ОрганВыдавшийДокумент КАК ОрганВыдавшийДокумент,
	|	ОбластиДействияСертификатовНоменклатуры.СертификатНоменклатуры.Номер КАК НомерСертификата,
	|	ОбластиДействияСертификатовНоменклатуры.СертификатНоменклатуры.Статус КАК Статус,
	|	ВТ_Товары.Ссылка КАК Ссылка,
	|	ВТ_Товары.Номенклатура КАК Номенклатура,
	|	ВТ_Товары.ВестиУчетСертификатовНоменклатуры КАК ВестиУчетСертификатовНоменклатуры
	|ИЗ
	|	ВТ_Товары КАК ВТ_Товары
