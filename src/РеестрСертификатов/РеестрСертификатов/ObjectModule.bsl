Функция ПечатьВнешнейПечатнойФормы(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Если ТипЗнч(МассивОбъектов[0]) = Тип("ДокументСсылка.ПоступлениеТоваровУслуг") Тогда
	
		ТекстЗапроса = Запрос.Текст;
		Текстзапроса = СтрЗаменить(ТекстЗапроса, "Документ.РеализацияТоваровУслуг", "Документ.ПоступлениеТоваровУслуг");
...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	//МассивНазначений = Новый Массив("Документ.РеализацияТоваровУслуг");
	//ПараметрыРегистрации.Вставить("Назначение", МассивНазначений);
	//ПараметрыРегистрации.Вставить("Наименование", "Реестр сертификатов (внешний)");
	//ПараметрыРегистрации.Вставить("Версия", "1.0");
	//ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	//ПараметрыРегистрации.Вставить("Информация", "");
	//ПараметрыРегистрации.Вставить("ВерсияБСП", "");
	//ТаблицаКоманд = ПолучитьТаблицуКоманд();
	//ДобавитьКоманду(ТаблицаКоманд,	"ВНЕШНИЙ: Реестр сертификатов", "ПФ_MXL_РеестрСертификатов", "ВызовСерверногоМетода",
	//Истина,
	//"ПечатьMXL");
	...
	ПараметрыРегистрации.Информация = "Печатная форма работает только для УТ не ниже версии 11.3.2.157";
